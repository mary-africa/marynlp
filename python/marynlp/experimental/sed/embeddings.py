...
class Embeddings(nn.Module):
    def __init__(self, embedding_dim, hidden_dim, token_vocab_size=None, composition_fn='non', batched_input=False, embed_path=None, morph_path=None):
    ...
    def embed(self, tokens, strings, store_path=None):
        ...
        emb_dict = {string : self.get_embeddings(token) for token, string in zip(tokens, strings)}
