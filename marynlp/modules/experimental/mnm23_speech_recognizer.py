...
from marynlp.text_encoders import CharacterEncoder, GreedyEncoder
from marynlp.models.speech_recogn_model import SpeechRecognitionModel
...
class MNMSpeechRecognizer(Module):
    pretrained_models = pretrained_models_class['voice']
